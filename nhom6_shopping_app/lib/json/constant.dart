...
const String homeImg =
    'https://icdn.dantri.com.vn/thumb_w/640/2021/03/08/screen-shot-20210308-at-104518-1615175939331.png';
...
List itemsTab = [
  ...
  {"icon": FontAwesomeIcons.house, "size": 22.0},
  {"icon": FontAwesomeIcons.locationDot, "size": 22.0},
  {"icon": FontAwesomeIcons.userLarge, "size": 21.0},
  {"icon": FontAwesomeIcons.bagShopping, "size": 22.0},
  {"icon": FontAwesomeIcons.ellipsis, "size": 30.0},
];
...
List storeList = [
  {
    "img":
        "https://inhat.vn/hcm/wp-content/uploads/2022/06/shop-quan-ao-thai-lan-tphcm3.png",
    "name": "Ngu Hanh Son, Da Nang",
    "open": 1
  },
  {
    "img":
